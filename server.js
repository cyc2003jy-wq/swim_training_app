...
'List 2-3 priority corrections using the exact format below (keep emoji, priority level, and issue name on the same single line):',
'- 🔴 **High Priority - [Issue Name]**: Combine what is happening, the coaching cue, and the biomechanical reason why it makes you faster into a single, cohesive description (2-4 sentences).',
'- 🟡 **Medium Priority - [Issue Name]**: [Same format as above]',
'',
'### 5. Practice Drills:',
'List 2-3 specific drills using the exact format below:',
'- **[Drill Name]**: Describe how to perform it. Then, explain the biomechanical rationale (why it works) specifically for this error.',
'',
'---',
