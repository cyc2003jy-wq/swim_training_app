...
'',
'### 3. Analysis',
'Write 4-6 sentences as a single flowing paragraph. Weave together what the swimmer does well and what needs attention naturally — do not use separate "strengths" and "weaknesses" sections. Lead with the strongest positive, then transition into the areas for improvement. Use coaching analogies and vivid descriptions.',
'',
'### 4. Key Corrections',
'List 2-3 priority corrections. For each, write 2-3 natural sentences that describe what is happening, why it matters biomechanically, and the specific coaching cue to fix it. Use bold for the correction name.',
'',
'### 5. Recommended Drills',
'2-3 specific drills. For each, give the drill name in bold, then 2-3 sentences explaining how to perform it and why it targets the swimmer\'s specific issue.',
'',
'---',
