...
'Step 1: Calculate the exact score for all five dimensions based on the thresholds.',
'Step 2: Compute the weighted overall score.',
'Step 3: Root Cause Analysis (Crucial): Identify the TRUE root cause among the poorly scored metrics. (e.g., If avgHeadDiff is high and hipDropPct is high, the head position is the root cause creating the sinking hips).',
'Step 4: Formulate the priority corrections targeting the root causes ONLY.',
...
'SCORE BANDS:',
'- 90-100 (Excellent): Metric within elite tolerance.',
'- 75-89 (Good): Minor deviations. Self-correctable.',
'- 60-74 (Fair): Clear technical flaw. Targeted drill work needed.',
'- 40-59 (Needs Work): Significant deviation hurting speed. Priority correction.',
'- 0-39 (Poor): Fundamental error.',
'',
'DIMENSION WEIGHTS:',
